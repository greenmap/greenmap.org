...
<?php print str_replace('&amp;', 'and', str_replace(',-', ' ', str_replace(array(' ', '.'), '-',strip_tags(render($content['field_project_theme']))))); ?>">
	<div class="portfolio-item img-thumbnail">
		<a href="<?php print $node_url; ?>" class="thumb-info">
			<?php print render ($content['field_image']); ?>
			<span class="thumb-info-title">
				<span class="thumb-info-inner"><?php print $title; ?></span>
				<span class="thumb-info-type"><?php print str_replace('-', ' ', strip_tags(render($content['field_project_theme']))); ?></span>
			</span>

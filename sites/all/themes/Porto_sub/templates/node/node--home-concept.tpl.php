			...
			<div class="col-md-2 col-md-offset-1">
				<div class="process-image" data-appear-animation="bounceIn">
				  <a href="<?php print strip_tags(render($content['field_circle_1_url'])); ?>">
					  <img src="<?php echo file_create_url($node->field_circle_1_image['und'][0]['uri']); ?>" alt="Identify, promote and link green sites" title="Identify, promote and link green sites">
				  </a>
